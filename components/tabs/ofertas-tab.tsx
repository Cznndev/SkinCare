...
export function OfertasTab() {
  ...
  const flashSaleProducts: OfferProduct[] = [
    {
      ...products.find((p) => p.id === "kit-completo")!,
      discount: 40,
      price: 239.94,
    ...
    {
      ...products.find((p) => p.id === "serum-vitamina-c")!,
      discount: 35,
      price: 84.44,
      timeLeft: timeLeft.hours * 3600 + timeLeft.minutes * 60 + timeLeft.seconds,
      stock: 8,
    ...
    {
      ...products.find((p) => p.id === "hidratante-anti-idade")!,
      discount: 30,
      price: 104.93,
      timeLeft: timeLeft.hours * 3600 + timeLeft.minutes * 60 + timeLeft.seconds,
      stock: 12,
  ...
  const dailyDeals: OfferProduct[] = [
    {
      ...products.find((p) => p.id === "kit-iniciante")!,
      discount: 25,
      price: 149.93,
      stock: 20,
      sold: 30,
    ...
    {
      ...products.find((p) => p.id === "protetor-solar")!,
      discount: 20,
      price: 63.92,
      stock: 25,
      sold: 15,
    ...
    {
      ...products.find((p) => p.id === "gel-limpeza")!,
      discount: 15,
      price: 76.42,
      stock: 30,
      sold: 20,
  ...
  const bundleOffers = [
    {
      id: "bundle-1",
      title: "Combo Skincare Completo",
      description: "Kit de limpeza + Hidratante + Protetor Solar",
      products: ["gel-limpeza", "hidratante-matificante", "protetor-solar"],
      originalPrice: 249.7,
      price: 179.9,
      discount: 28,
      image: "https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=400&h=300&fit=crop&crop=center&q=80",
      badge: "Mais Vendido",
    },
    {
      id: "bundle-2",
      title: "Duo Anti-Idade Premium",
      description: "Sérum Vitamina C + Hidratante Anti-Idade",
      products: ["serum-vitamina-c", "hidratante-anti-idade"],
      originalPrice: 279.8,
      price: 199.9,
      discount: 29,
      image: "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=400&h=300&fit=crop&crop=center&q=80",
      badge: "Premium",
    },
  ]
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {bundleOffers.map((bundle) => (
              <Card key={bundle.id} className="border-0 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                <CardContent className="p-0">
                  <div className="relative">
                    ...
                    />
                    <Badge className="absolute top-4 left-4 bg-purple-600 text-white">{bundle.badge}</Badge>
                    <div className="absolute top-4 right-4 bg-white dark:bg-slate-800 text-slate-900 dark:text-white px-3 py-1 rounded-full font-bold">
                      -{bundle.discount}%
                    </div>
                  </div>
                  <div className="p-6">
                    <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{bundle.title}</h4>
                    <p className="text-slate-600 dark:text-slate-300 mb-4">{bundle.description}</p>

                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-3">
                        <span className="text-2xl font-bold text-purple-600">{formatPrice(bundle.price)}</span>
                        <span className="text-lg text-slate-500 line-through">{formatPrice(bundle.originalPrice)}</span>
                      </div>
                      <Badge variant="outline" className="text-green-600 border-green-600">
                        Economize {formatPrice(bundle.originalPrice - bundle.price)}
                      </Badge>
                    </div>

                    <div className="space-y-2 mb-6">
                      <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Produtos inclusos:</p>
